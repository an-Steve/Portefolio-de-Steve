...
const translations = {
    fr: {
        ...
        'about-formation-value': 'Master en Ingénierie en Intelligence Artificielle',
        'about-github': ' Github',
        ...
        'formation-master': 'Master en Ingénierie en Intelligence Artificielle',
        ...
        'exp-subtitle-stages': 'Expériences académiques',
        'exp-subtitle-pro': 'Parcours professionnel',
        'exp-subtitle-benevole': 'Bénévolat',
        'exp-thales-badge': 'Alternance Master 2',
        'exp-thales-title': 'Ingénieur Data et Intelligence artificielle',
        'exp-thales-date': '05 octobre 2026 au 30 septembre 2027',
        'exp-thales-location': 'Gennevilliers',
        'exp-thales-task1': 'Développement d’applications d’Intelligence Artificielle',
        'exp-thales-task2': 'Développement d’outils et d’applications basés sur l’IA',
        'exp-thales-task3': 'Exploitation et valorisation des données projet',
        'exp-thales-task4': 'Expérimentation de solutions d’IA générative (LLM, RAG, MCP)',
        'exp-thales-task5': 'Identification et intégration de cas d’usage IA dans les communications navales',
        'exp-thales-task6': 'Développement en Python et C++',
        'exp-thales-task7': 'Collaboration avec les architectes et experts techniques',
        'exp-thales-report': 'Voir le rapport de stage',
        'exp-capgemini-report': 'Voir le rapport de stage',
        'exp-capgemini-attestation': 'Voir l’attestation de stage',
        "skills-acquired": "Compétences acquises",
        "stress": "🧘 Gestion du stress",
        "caces": "🚜 CACES",
        "rigor": "⏱️ Rigueur & rapidité",
        "teamwork": "🤝 Travail en équipe",
        "night": "🌙 Travail de nuit (les samedis de 19h à 3h)",
        ...
        'exp-tiqtec-report-text': 'Voir le rapport de stage',
        'exp-streamvision-report-text': 'Voir le rapport de stage',
        ...
        'skill-rag': 'RAG',
        'skill-mcp': 'MCP',
        'skill-generative-ai': 'IA générative',
        'skill-llm': 'LLM',
        'skill-mistral-ai': 'Mistral AI',
        'skill-project-management': 'Gestion de Projet',
        'skill-gantt': 'GANTT',
        'skill-jira': 'JIRA',
    ...
    en: {
        ...
        'about-formation': '<i class="fas fa-graduation-cap"></i>Formation',
        'about-formation-value': "Master's in Artificial Intelligence Engineering",
        'about-github': ' Github',
        'about-linkedin': ' LinkedIn',
        ...
        'formation-master': "Master's in Artificial Intelligence Engineering",
        ...
        'exp-subtitle-stages': 'Academic Experiences',
        'exp-subtitle-pro': 'Professional Experience',
        'exp-subtitle-benevole': 'Volunteering',
        'exp-thales-badge': 'Master 2 Apprenticeship',
        'exp-thales-title': 'Data and Artificial Intelligence Engineer',
        'exp-thales-date': 'October 5, 2026 to September 30, 2027',
        'exp-thales-location': 'Gennevilliers',
        'exp-thales-task1': 'Development of Artificial Intelligence applications',
        'exp-thales-task2': 'Development of AI-based tools and applications',
        'exp-thales-task3': 'Exploitation and enhancement of project data',
        'exp-thales-task4': 'Experimentation of generative AI solutions (LLM, RAG, MCP)',
        'exp-thales-task5': 'Identification and integration of AI use cases in naval communications',
        'exp-thales-task6': 'Development in Python and C++',
        'exp-thales-task7': 'Collaboration with architects and technical experts',
        'exp-thales-report': 'View internship report',
        'exp-capgemini-report': 'View project report',
        'exp-capgemini-attestation': 'View internship certificate',
        ...
        "teamwork": "🤝 Teamwork",
        "night": "🌙 Night shift work (Saturdat  from 7pm to 3am)",
        "skill-animation": "🎯 Animation",
        ...
        'skill-rag': 'RAG',
        'skill-mcp': 'MCP',
        'skill-generative-ai': 'Generative AI',
        'skill-llm': 'LLM',
        'skill-mistral-ai': 'Mistral AI',
